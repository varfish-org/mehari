...
fn default_available_parallelism() -> std::num::NonZero<usize> {
    std::thread::available_parallelism().unwrap_or(std::num::NonZero::new(1).unwrap()) // this unwrap can't produce a panic
}
